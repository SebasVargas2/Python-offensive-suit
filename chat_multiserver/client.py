...
def exit_request(client_socket, username, window):
    client_socket.sendall(f'\n[!] El usuario {username} ha dejado la sala de chat.\n'.encode())
    client_socket.close()
...
def client_program():
    ...
    frame_widget.pack(pady=10, padx=5, fill=BOTH, expand=1)
